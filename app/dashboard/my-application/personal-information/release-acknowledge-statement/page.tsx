...
const ReleaseAcknowledgeStatementPage = () => {
        ...
        <section>
          ...
          <div className="mt-5">
            <button
              onClick={() => {
                if (canContinue) {
                  router.push("/dashboard/my-application/personal-information/biometric-information");
                }
              }}
...
export default ReleaseAcknowledgeStatementPage;
