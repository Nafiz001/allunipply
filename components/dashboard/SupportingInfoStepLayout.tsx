...
export type SupportingStepKey = "documents";

type SupportingStep = {
  key: SupportingStepKey;
  label: string;
  href: string;
};

type SupportingInfoStepLayoutProps = {
  activeStep: SupportingStepKey;
  title: string;
  description?: string;
  children: React.ReactNode;
  steps?: SupportingStep[];
  showClose?: boolean;
  closeHref?: string;
};

const defaultSteps: SupportingStep[] = [
  {
    key: "documents",
    label: "Documents",
...
const SupportingInfoStepLayout = ({
  activeStep,
  title,
  description,
  children,
              ...
              <div className="flex flex-col items-center text-center mb-4">
                <div className="relative w-24 h-24">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <FileText size={24} className="text-[#E3572B]" />
                  </div>
                </div>
                <p className="text-xs text-gray-600 font-outfit mt-1">0/4</p>
                <h3 className="font-outfit font-bold text-[34px] leading-none text-gray-900 mt-2">
...
export default SupportingInfoStepLayout;
